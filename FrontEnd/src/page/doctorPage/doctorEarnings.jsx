...
const DoctorEarningsDashboard = () => {  const [stats, setStats] = useState({});
  ...
  return (
    <div className="container mx-auto px-4 py-6">      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Thu nhập của tôi</h1>
        <p className="text-gray-600">Quản lý và theo dõi thu nhập từ tư vấn</p>
      </div>
      ...
      <div className="mb-6">
        ...
        {showDebug && (
          <div className="mt-4 p-4 bg-gray-100 rounded-lg border">
            <h3 className="text-lg font-semibold mb-3">Debug Authentication</h3>            <div className="space-x-3">
              <button 
            ...
            <p className="text-sm text-gray-600 mt-2">
              Mở Developer Console (F12) để xem kết quả debug
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg mb-6">
        ...
        <div className="p-6">          {activeTab === 'overview' && (
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Tổng quan thu nhập</h3>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl mb-6 border border-blue-100">
                <h4 className="text-md font-medium text-gray-700 mb-4 flex items-center">
                  ...
                  Cài đặt Hoa hồng và Phí nền tảng
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg border border-blue-200">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 font-medium">Tỷ lệ hoa hồng:</span>
                      <span className="font-bold text-green-600 text-lg">
                        {commissionRate !== null ? `${commissionRate}%` : 'Đang tải...'}
                      </span>
                    </div>
                    <p className="text-sm text-gray-500 mt-1">Phần bạn nhận được từ mỗi tư vấn</p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border border-blue-200">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600 font-medium">Phí nền tảng:</span>
                      <span className="font-bold text-blue-600 text-lg">
                        {platformFee !== null ? `${platformFee}%` : 'Đang tải...'}
                      </span>
                    </div>
                    <p className="text-sm text-gray-500 mt-1">Phần nền tảng giữ lại</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-md font-medium text-gray-700 mb-3">Thống kê nhanh</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Số lần tư vấn:</span>
                      <span className="font-medium">{earnings.length}</span>
                    </div>
                  </div>
                </div>
                <div>
                  <h4 className="text-md font-medium text-gray-700 mb-3">Hoạt động gần đây</h4>
          ...
          {activeTab === 'history' && (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Lịch sử thu nhập</h3>
          ...
          {activeTab === 'monthly' && (
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Báo cáo theo tháng</h3>
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
