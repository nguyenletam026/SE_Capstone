...
export default function HelpAndFeedback() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-yellow-200 flex flex-col items-center justify-center px-4 sm:px-6 py-6 sm:py-10">
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl w-full max-w-3xl p-6 sm:p-8 lg:p-10">
        <h2 className="text-2xl sm:text-3xl font-bold text-brown-700 mb-3 sm:mb-4 text-center">Trợ Giúp & Góp Ý</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Email của bạn (tùy chọn)</label>
            <input
              type="email"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Loại phản hồi</label>
            <select
              className="w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-[#9BB168] text-sm sm:text-base"
              value={category}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Nội dung phản hồi</label>
            <textarea
