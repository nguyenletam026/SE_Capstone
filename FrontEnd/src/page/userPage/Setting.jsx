...
export default function Settings() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-100 to-yellow-200 flex flex-col items-center justify-center px-4 sm:px-6 py-6 sm:py-10">
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-2xl p-6 sm:p-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-brown-700 mb-4 sm:mb-6 text-center">Cài Đặt Tài Khoản</h2>
        ...
        <div className="space-y-4 sm:space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Thông báo</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Chế độ giao diện</label>
            <select
              className="block w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-[#9BB168] text-sm sm:text-base"
              value={theme}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Ngôn ngữ</label>
            <select
              className="block w-full border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:ring-2 focus:ring-[#9BB168] text-sm sm:text-base"
              value={language}
