...
const Footer = () => {
  return (
    <footer>
      ...
      <div
        className="grid grid-cols-3 items-center bg-[#FFFAD6] py-8 px-2"
      ...
      {/* Main Footer Content */}
      <div className="grid grid-cols-12 gap-4 bg-[#FFFAD6] py-8 px-4" style={{ fontFamily: "Jomolhari" }}>
        {/* About Us Section */}
      ...
      {/* Copyright Section */}
      <div className="bg-[#FFFAD6] py-4 border-t-2 border-[#9e645b]">
